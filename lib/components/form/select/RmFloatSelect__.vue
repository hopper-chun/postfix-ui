  ...
  <div :ref="containerRefFunc">
    <div class="relative select-none">
      <div class="relative">
        ...
        >
          <div
            class="absolute inset-0 flex transform items-center text-[#A3A3A3] transition-all duration-200"
            :class="[theme.fontSize, theme.paddingX, isOpen ? '-translate-y-[25%] text-[10px]' : '', localValue !== '' ? '-translate-y-[25%] text-[10px]' : '']"
          >
            {{ label }}
          </div>
