...
const currentValue = computed(() => {
  if (props.optionsLabel(localValue)) {
    return props.optionsLabel(localValue)
  } else return ''
})
    ...
    <div class="relative select-none">
      ...
      <div class="relative">
        <div
          ...
          :id="randomId"
          @click="handleOpen"
          class="items-centerfocus:outline-none relative flex focus:ring-1"
          :class="[
            theme.height,
            theme.border,
            theme.radius,
            ...
            label ? 'mt-[4px]' : '',
            truncate ? `pr-[42px] ${theme.paddingX}` : '',
          ]"
          tabindex="0"
        >
          ...
          <span
            class="flex h-full items-center leading-[22px]"
            :class="[theme.fontSize, theme.paddingX, localValue ? theme.text.color : 'text-[#A3A3A3]', truncate ? 'absolute inset-x-0 truncate pr-[32px]' : '']"
          >
          ...
          <div class="flex items-center justify-center" :class="[truncate ? 'absolute inset-y-0 right-[10px]' : 'pr-[10px]']">
            <slot name="expand">
        ...
        >
          ...
          >
            <div
              ...
              class="relative flex cursor-default items-center justify-between leading-[22px]"
              :class="[
                theme.paddingX,
                ...
                optionsLabel(localValue) === optionsLabel(option) ? `pr-[22px] ${theme.select_optionSelected}` : '',
              ]"
            >
