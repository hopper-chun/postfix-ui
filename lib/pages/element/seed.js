...
`,
  roundedButton: `
<div class="w-[32px]">
  <PxButton color="pri" isFull size="sm" :styles="{ radius: 'rounded-full' }">
    <IconApi class="w-[18px]"></IconApi>
  </PxButton>
</div>

<div class="w-[40px]">
  <PxButton color="pri" isFull :styles="{ radius: 'rounded-full' }">
    <IconApi class="w-[21px]"></IconApi>
  </PxButton>
</div>

<div class="w-[48px]">
  <PxButton color="pri" isFull size="lg" :styles="{ radius: 'rounded-full' }">
