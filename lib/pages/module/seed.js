...
<template>
  <div>
    <div class="w-[100px]">
      <RmButton :isFull="true" @click="handleOpen">Simple</RmButton>
    </div>
    <div>
      <RmDialog ref="simple">
        <template v-slot="{ closeDialog }">
          <div class="bg-white flex flex-col w-[600px] rounded-[12px] h-[200px]">
            ...
            <div class="px-[20px] mb-[20px]">
              <RmButton :isFull="true" @click="closeDialog">닫기</RmButton>
            </div>
          </div>
        </template>
      </RmDialog>
...
<template>
  <div>
    <div class="w-[100px]">
      <RmButton :isFull="true" @click="handleOpen" color="secondary">Common</RmButton>
    </div>
    <div>
      <RmDialog ref="common">
        <template v-slot="{ closeDialog }">
